...
class Character:
    ...
    # const for range of attack values
    RANGE_VALUE_ATTACK = (1, 3)
    # const for range of deffence values
    ...
    def attack(self):
        # Describe method of attack
        value_attack = DEFAULT_ATTACK + randint(*self.RANGE_VALUE_ATTACK)
        return (f'{self.name} нанёс противнику урон, равный {value_attack}')

    def defence(self):
        # Describe method of defence
...
char_class = choice_char_class('Кодослав')
